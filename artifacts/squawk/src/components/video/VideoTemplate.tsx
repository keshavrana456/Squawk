...
import { SceneChirps } from './video_scenes/SceneChirps';
...
export default function VideoTemplate() {
  ...
  return (
    <div className="relative w-full h-[100vh] overflow-hidden bg-black text-white font-sans select-none" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      {/* Midground Persistent Elements — 10 values for 10 scenes */}
      <motion.div
        className="absolute w-[2px] bg-gradient-to-b from-transparent via-[#ff2d92] to-transparent pointer-events-none z-0"
        animate={{
          left:    ['10vw', '85vw', '30vw', '70vw', '20vw', '55vw', '80vw', '15vw', '50vw', '45vw'][currentScene],
          height:  ['30vh', '80vh', '40vh', '100vh', '60vh', '70vh', '20vh', '90vh', '50vh', '20vh'][currentScene],
          top:     ['10vh', '5vh', '40vh', '0vh', '20vh', '15vh', '60vh', '5vh', '25vh', '40vh'][currentScene],
          opacity: currentScene === 9 ? 0 : 0.6,
        }}
      ...
      <motion.div
        ...
        animate={{
          top:     ['80vh', '20vh', '70vh', '15vh', '85vh', '50vh', '30vh', '10vh', '90vh', '50vh'][currentScene],
          width:   ['40vw', '90vw', '30vw', '60vw', '80vw', '65vw', '20vw', '70vw', '50vw', '20vw'][currentScene],
          left:    ['10vw', '5vw', '50vw', '20vw', '10vw', '20vw', '60vw', '15vw', '25vw', '40vw'][currentScene],
          opacity: currentScene === 9 ? 0 : 0.5,
        }}
      ...
      <AnimatePresence mode="sync">
        ...
        {currentScene === 5 && <SceneChirps key="schirps" />}
        {currentScene === 6 && <Scene6 key="s6" />}
        {currentScene === 7 && <Scene7 key="s7" />}
